...
db.ActivityInfo = require("./activityInfo.model.js")(sequelize, DataTypes);
...
db.Essay = require("./essay.model.js")(sequelize, DataTypes);
db.LoginHistory = require("./loginHistory.model.js")(sequelize, DataTypes);
...
db.User.hasMany(db.Essay, { foreignKey: "userId" });
db.Essay.belongsTo(db.User, { foreignKey: "userId" });
